...
// The window subclass ID that enables the window to receive
// WM_DPICHANGED notifications.
constexpr UINT kChildWindowId = 1;
...
// Scale helper to convert logical scaler values to physical using given scale
// factor.
...
bool Win32Window::OnCreate() {
    // No-op; provided for subclass override.
    return true;
}
